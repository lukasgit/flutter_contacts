...
public class ContactsServicePlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    public void onMethodCall(MethodCall call, Result result) {
        switch (call.method) {
            ...
            case "getPhoneNumberContacts": {
                this.getPhoneNumberContacts(call.method, result);
                break;
            }
    ...
    @TargetApi(Build.VERSION_CODES.ECLAIR)
    private void getPhoneNumberContacts(String callMethod, Result result) {
        new GetContactsTask(callMethod, result, false, false, false).executeOnExecutor(executor, null, false);
    }
    ...
    private class GetContactsTask extends AsyncTask<Object, Void, ArrayList<HashMap>> {
        ...
        protected ArrayList<HashMap> doInBackground(Object... params) {
            ...
            if (callMethod.equals("getPhoneNumberContacts")) {
                ...
                Collections.sort(phoneContacts, compareByGivenName);
