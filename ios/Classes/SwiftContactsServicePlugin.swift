...
public class SwiftContactsServicePlugin: NSObject, FlutterPlugin, CNContactViewControllerDelegate, CNContactPickerDelegate {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "github.com/davidfranquet/flutter_contacts", binaryMessenger: registrar.messenger())
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "updateContact":
         ...
         case "openContactForm":
            ...
            self.result = result
            _ = openContactForm()
        case "preLoadUnknownContactView":
          let contact = dictionaryToContact(dictionary: call.arguments as! [String : Any])
          localizedLabels = true
          self.result = result
          _ = preLoadUnknownContactView(contact: contact)
